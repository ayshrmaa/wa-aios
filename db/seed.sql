...
from (
  ...
  from contacts c
  where c.tenant_id = '11111111-1111-4111-8111-111111111111'::uuid and c.created_at >= now() - interval '21 days'
) c
left join lateral (
